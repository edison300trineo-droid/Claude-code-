...
COLUMN_WIDTHS = [16, 16, 16, 20, 14, 16, 30, 13, 12, 10, 40]
...
EXAMPLE_ROWS = [
    ["QT114001", "C-114-021", "TMT-114-003", "宏碩生技", "GLP 研究", "試驗執行中",
     "第 28 天中期報告", "2026-10-15", "陳彥廷", "進行中", "SD 大鼠 28 天重複劑量毒性"],
    ["QT114002", "C-114-021", "", "宏碩生技", "藥理試驗", "計畫書撰寫",
     "計畫書送客戶確認", "2026-09-30", "林郁涵", "需留意", "與 QT114001 同一份合約"],
    ["QT114003", "", "", "光宇製藥", "Pilot study", "計畫書撰寫",
     "報價確認", "", "王孟儒", "進行中", "尚未簽約，合約與研究編號待補"],
]
